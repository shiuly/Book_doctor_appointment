        ...
        <nav class="navbar navbar-expand-lg navbar-light bg-light">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav mr-auto">
                    ...
                    <li class="nav-item active">
                        <a class="nav-link" href="adminlogin.jsp"> ADMINLOGIN <span class="sr-only">(current)</span></a>
                    </li>
                </ul>
        ...
        <div class="container-fluid text-center">  
            ...
            <div class="row content">
                <div class="col-sm-2 sidenav">
                    <p> <img src="pic/doctor.jpg" class="rounded-circle" alt="pic" width="150" height="150"/></p>
                ...
                <div class="col-sm-8 text-left"> 
                    ...
                    <body>
                        ...
                        <center>  <h3> <p style="color:red">You have been successfully logout</p></h3
                            <p><img src="pic/l.jpg" alt="log out"></img></p>
