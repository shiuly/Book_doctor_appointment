        ...
        <nav class="navbar navbar-expand-lg navbar-light bg-light">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav mr-auto">
                    ...
                    <li class="nav-item active">
                        <a class="nav-link" href="adminAddDoctor.xhtml">Add Doctor <span class="sr-only">(current)</span></a>
                    </li>
                   
                    <li class="nav-item active">
                        <a class="nav-link" href="#">View Patient <span class="sr-only">(current)</span></a>
                    </li>
                    <li class="nav-item active">
        ...
        <div class="container-fluid text-center">  
            ...
            <div class="row content">
                ...
                <div class="col-sm-8 text-left"> 
                    ...
                    <center>  <h2 style="color: red">Welcome, <%=session.getAttribute("name")%></h2>

                        <p><img src="pic/admin.jpg" ></img></p></center>
